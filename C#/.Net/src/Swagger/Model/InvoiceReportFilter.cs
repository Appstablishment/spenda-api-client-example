...
namespace Swagger.Model {
  ...
  public class InvoiceReportFilter {
    /// <summary>
    /// Gets or Sets IncludeSalesChannel
    /// </summary>
    [DataMember(Name="IncludeSalesChannel", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "IncludeSalesChannel")]
    public bool? IncludeSalesChannel { get; set; }

    /// <summary>
    /// Gets or Sets IncludePaymentMethod
    /// </summary>
    [DataMember(Name="IncludePaymentMethod", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "IncludePaymentMethod")]
    public bool? IncludePaymentMethod { get; set; }

    /// <summary>
    /// Gets or Sets IncludeReps
    /// </summary>
    [DataMember(Name="IncludeReps", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "IncludeReps")]
    public bool? IncludeReps { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class InvoiceReportFilter {\n");
      sb.Append("  IncludeSalesChannel: ").Append(IncludeSalesChannel).Append("\n");
      sb.Append("  IncludePaymentMethod: ").Append(IncludePaymentMethod).Append("\n");
      sb.Append("  IncludeReps: ").Append(IncludeReps).Append("\n");
