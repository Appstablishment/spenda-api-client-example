...
namespace Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class PagedActionResultsOfSupplierTransLineGroupT {
    /// <summary>
    ...
    public SupplierTransLineGroupT Value { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class PagedActionResultsOfSupplierTransLineGroupT {\n");
