...
namespace Swagger.Model {
  ...
  public class CustomerSaveRequest {
    /// <summary>
    /// Gets or Sets LinkedCustomer
    /// </summary>
    [DataMember(Name="LinkedCustomer", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "LinkedCustomer")]
    public CustomerT LinkedCustomer { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class CustomerSaveRequest {\n");
      sb.Append("  LinkedCustomer: ").Append(LinkedCustomer).Append("\n");
