...
namespace Swagger.Model {
  ...
  public class PurchaseInvoiceT {
    ...
    /// <summary>
    /// Gets or Sets PurchaseOrderRefNUmber
    /// </summary>
    [DataMember(Name="PurchaseOrderRefNUmber", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "PurchaseOrderRefNUmber")]
    public string PurchaseOrderRefNUmber { get; set; }

    /// <summary>
    /// Gets or Sets SupplierInvoiceRefNumber
    /// </summary>
    [DataMember(Name="SupplierInvoiceRefNumber", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "SupplierInvoiceRefNumber")]
    public string SupplierInvoiceRefNumber { get; set; }

    /// <summary>
    /// Gets or Sets HasTotalDiscrepancy
    /// </summary>
    [DataMember(Name="HasTotalDiscrepancy", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "HasTotalDiscrepancy")]
    public bool? HasTotalDiscrepancy { get; set; }
    ...
    /// <summary>
    /// Gets or Sets SupplierRefTransRefNumber
    /// </summary>
    [DataMember(Name="SupplierRefTransRefNumber", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "SupplierRefTransRefNumber")]
    public string SupplierRefTransRefNumber { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class PurchaseInvoiceT {\n");
      sb.Append("  PurchaseOrderID: ").Append(PurchaseOrderID).Append("\n");
      sb.Append("  CampaignID: ").Append(CampaignID).Append("\n");
      sb.Append("  PurchaseOrderRefNUmber: ").Append(PurchaseOrderRefNUmber).Append("\n");
      sb.Append("  SupplierInvoiceRefNumber: ").Append(SupplierInvoiceRefNumber).Append("\n");
      sb.Append("  HasTotalDiscrepancy: ").Append(HasTotalDiscrepancy).Append("\n");
      ...
      sb.Append("  ExpectedTotalEx: ").Append(ExpectedTotalEx).Append("\n");
      ...
      sb.Append("  SupplierRefTransRefNumber: ").Append(SupplierRefTransRefNumber).Append("\n");
