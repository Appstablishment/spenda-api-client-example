...
namespace Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class PagedActionResultsOfSupplierTransGroups {
    /// <summary>
    ...
    public List<SupplierTransGroupT> Value { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class PagedActionResultsOfSupplierTransGroups {\n");
