...
namespace Swagger.Model {
  ...
  public class PaymentSearchFilter {
    ...
    /// <summary>
    /// Gets or Sets POSTerminalID
    /// </summary>
    [DataMember(Name="POSTerminalID", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "POSTerminalID")]
    ...
    /// <summary>
    /// Gets or Sets DatTypes
    /// </summary>
    [DataMember(Name="DatTypes", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "DatTypes")]
    public List<string> DatTypes { get; set; }

    /// <summary>
    /// Gets or Sets MaxExpiresInDays
    /// </summary>
    [DataMember(Name="MaxExpiresInDays", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "MaxExpiresInDays")]
    public int? MaxExpiresInDays { get; set; }
    ...
    /// <summary>
    /// Gets or Sets IsCreatedByOtherPartyOnly
    /// </summary>
    [DataMember(Name="IsCreatedByOtherPartyOnly", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "IsCreatedByOtherPartyOnly")]
    public bool? IsCreatedByOtherPartyOnly { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class PaymentSearchFilter {\n");
      sb.Append("  ReceiptID: ").Append(ReceiptID).Append("\n");
      sb.Append("  POSTerminalID: ").Append(POSTerminalID).Append("\n");
      sb.Append("  BusinessID: ").Append(BusinessID).Append("\n");
      sb.Append("  CustomerID: ").Append(CustomerID).Append("\n");
      sb.Append("  SupplierID: ").Append(SupplierID).Append("\n");
      sb.Append("  WarehouseID: ").Append(WarehouseID).Append("\n");
      sb.Append("  DeliveryMethods: ").Append(DeliveryMethods).Append("\n");
      sb.Append("  DatTypes: ").Append(DatTypes).Append("\n");
      sb.Append("  MaxExpiresInDays: ").Append(MaxExpiresInDays).Append("\n");
      sb.Append("  RepUserID: ").Append(RepUserID).Append("\n");
      sb.Append("  IsCreatedByOtherPartyOnly: ").Append(IsCreatedByOtherPartyOnly).Append("\n");
