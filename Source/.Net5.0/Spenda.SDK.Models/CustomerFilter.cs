...
namespace Spenda.SDK.Models {
  ...
  public class CustomerFilter {
    /// <summary>
    /// Gets or Sets GetIsValidForBillToOnly
    /// </summary>
    [DataMember(Name="GetIsValidForBillToOnly", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "GetIsValidForBillToOnly")]
    public bool? GetIsValidForBillToOnly { get; set; }
    ...
    /// <summary>
    /// Gets or Sets IsLinkedCustomersOnly
    /// </summary>
    [DataMember(Name="IsLinkedCustomersOnly", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "IsLinkedCustomersOnly")]
    public bool? IsLinkedCustomersOnly { get; set; }
    ...
    /// <summary>
    /// Gets or Sets IsShowAccountCustomersOnly
    /// </summary>
    [DataMember(Name="IsShowAccountCustomersOnly", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "IsShowAccountCustomersOnly")]
    public bool? IsShowAccountCustomersOnly { get; set; }
    ...
    /// <summary>
    /// Gets or Sets IsCODorPrePaidAccountCustomersOnly
    /// </summary>
    [DataMember(Name="IsCODorPrePaidAccountCustomersOnly", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "IsCODorPrePaidAccountCustomersOnly")]
    public bool? IsCODorPrePaidAccountCustomersOnly { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("  GetIsValidForBillToOnly: ").Append(GetIsValidForBillToOnly).Append("\n");
      sb.Append("  CreatedByUserID: ").Append(CreatedByUserID).Append("\n");
      sb.Append("  CustomerID: ").Append(CustomerID).Append("\n");
      sb.Append("  IsLinkedCustomersOnly: ").Append(IsLinkedCustomersOnly).Append("\n");
      ...
      sb.Append("  IsShowAccountCustomersOnly: ").Append(IsShowAccountCustomersOnly).Append("\n");
      sb.Append("  AccountCustomerID: ").Append(AccountCustomerID).Append("\n");
      sb.Append("  IsCODorPrePaidAccountCustomersOnly: ").Append(IsCODorPrePaidAccountCustomersOnly).Append("\n");
