...
namespace Spenda.SDK.Models {
  ...
  /// </summary>
  [DataContract]
  public class MergeInventoryLineRequest {
    /// <summary>
    /// Gets or Sets ID
    /// </summary>
    ...
    [JsonProperty(PropertyName = "InventoryDetails")]
    public InventoryItemT InventoryDetails { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class MergeInventoryLineRequest {\n");
