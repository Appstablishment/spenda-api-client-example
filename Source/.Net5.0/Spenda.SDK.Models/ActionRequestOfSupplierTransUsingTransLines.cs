...
namespace Spenda.SDK.Models {
  ...
  /// </summary>
  [DataContract]
  public class ActionRequestOfSupplierTransUsingTransLines {
    /// <summary>
    /// Gets or Sets Value
    /// </summary>
    [DataMember(Name="Value", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "Value")]
    public SupplierTransUsingTransLines Value { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class ActionRequestOfSupplierTransUsingTransLines {\n");
