...
namespace Spenda.SDK.Models {
  ...
  public class InvoiceT {
    ...
    [JsonProperty(PropertyName = "ContactUserID")]
    public int? ContactUserID { get; set; }

    /// <summary>
    /// Gets or Sets CustomersDefaultWarehouseID
    /// </summary>
    [DataMember(Name="CustomersDefaultWarehouseID", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "CustomersDefaultWarehouseID")]
    public int? CustomersDefaultWarehouseID { get; set; }

    /// <summary>
    /// Gets or Sets DeliveryDateString
    /// </summary>
    [DataMember(Name="DeliveryDateString", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "DeliveryDateString")]
    public string DeliveryDateString { get; set; }

    /// <summary>
    /// Gets or Sets IsAssetSale
    /// </summary>
    [DataMember(Name="IsAssetSale", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "IsAssetSale")]
    public bool? IsAssetSale { get; set; }

    /// <summary>
    /// Gets or Sets IsCustomPrices
    /// </summary>
    [DataMember(Name="IsCustomPrices", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "IsCustomPrices")]
    public bool? IsCustomPrices { get; set; }
    ...
    /// <summary>
    /// Gets or Sets SalesOrderRefNumber
    /// </summary>
    [DataMember(Name="SalesOrderRefNumber", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "SalesOrderRefNumber")]
    public string SalesOrderRefNumber { get; set; }

    /// <summary>
    /// Gets or Sets ServiceJobID
    /// </summary>
    [DataMember(Name="ServiceJobID", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "ServiceJobID")]
    public int? ServiceJobID { get; set; }

    /// <summary>
    /// Gets or Sets ServiceJobRefNumber
    /// </summary>
    [DataMember(Name="ServiceJobRefNumber", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "ServiceJobRefNumber")]
    public string ServiceJobRefNumber { get; set; }
    ...
    /// <summary>
    /// Gets or Sets DueInNoOfDays
    /// </summary>
    [DataMember(Name="DueInNoOfDays", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "DueInNoOfDays")]
    public int? DueInNoOfDays { get; set; }

    /// <summary>
    /// Gets or Sets OverDueByNoOfDays
    /// </summary>
    [DataMember(Name="OverDueByNoOfDays", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "OverDueByNoOfDays")]
    public int? OverDueByNoOfDays { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("  CustomersDefaultWarehouseID: ").Append(CustomersDefaultWarehouseID).Append("\n");
      sb.Append("  DeliveryDateString: ").Append(DeliveryDateString).Append("\n");
      sb.Append("  IsAssetSale: ").Append(IsAssetSale).Append("\n");
      sb.Append("  IsCustomPrices: ").Append(IsCustomPrices).Append("\n");
      sb.Append("  SalesOrderID: ").Append(SalesOrderID).Append("\n");
      sb.Append("  SalesOrderRefNumber: ").Append(SalesOrderRefNumber).Append("\n");
      sb.Append("  ServiceJobID: ").Append(ServiceJobID).Append("\n");
      sb.Append("  ServiceJobRefNumber: ").Append(ServiceJobRefNumber).Append("\n");
      sb.Append("  TotalRefund: ").Append(TotalRefund).Append("\n");
      sb.Append("  DueInNoOfDays: ").Append(DueInNoOfDays).Append("\n");
      sb.Append("  OverDueByNoOfDays: ").Append(OverDueByNoOfDays).Append("\n");
