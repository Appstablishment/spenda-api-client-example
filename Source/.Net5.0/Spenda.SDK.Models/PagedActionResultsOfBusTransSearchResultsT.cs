...
namespace Spenda.SDK.Models {
  ...
  /// </summary>
  [DataContract]
  public class PagedActionResultsOfBusTransSearchResultsT {
    /// <summary>
    ...
    public List<BusTransSearchResultT> Value { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class PagedActionResultsOfBusTransSearchResultsT {\n");
