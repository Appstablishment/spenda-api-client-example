...
namespace Spenda.SDK.Models {
  ...
  public class SupplierFilter {
    /// <summary>
    /// Gets or Sets InventoryFulfilmentID
    /// </summary>
    [DataMember(Name="InventoryFulfilmentID", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "InventoryFulfilmentID")]
    public int? InventoryFulfilmentID { get; set; }

    /// <summary>
    /// Gets or Sets InventoryIDs
    /// </summary>
    ...
    /// <summary>
    /// Gets or Sets SupplierTypes
    /// </summary>
    [DataMember(Name="SupplierTypes", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "SupplierTypes")]
    public List<string> SupplierTypes { get; set; }

    /// <summary>
    /// Gets or Sets IsLinkedSuppliersOnly
    /// </summary>
    [DataMember(Name="IsLinkedSuppliersOnly", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "IsLinkedSuppliersOnly")]
    public bool? IsLinkedSuppliersOnly { get; set; }

    /// <summary>
    /// Gets or Sets IgnoreProspectID
    /// </summary>
    [DataMember(Name="IgnoreProspectID", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "IgnoreProspectID")]
    public int? IgnoreProspectID { get; set; }

    /// <summary>
    /// Gets or Sets IsExactCodeSearch
    /// </summary>
    [DataMember(Name="IsExactCodeSearch", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "IsExactCodeSearch")]
    public bool? IsExactCodeSearch { get; set; }

    /// <summary>
    /// Gets or Sets IsExactEmailSearch
    /// </summary>
    [DataMember(Name="IsExactEmailSearch", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "IsExactEmailSearch")]
    public bool? IsExactEmailSearch { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class SupplierFilter {\n");
      sb.Append("  InventoryFulfilmentID: ").Append(InventoryFulfilmentID).Append("\n");
      sb.Append("  InventoryIDs: ").Append(InventoryIDs).Append("\n");
      sb.Append("  SupplierTypes: ").Append(SupplierTypes).Append("\n");
      sb.Append("  IsLinkedSuppliersOnly: ").Append(IsLinkedSuppliersOnly).Append("\n");
      sb.Append("  IgnoreProspectID: ").Append(IgnoreProspectID).Append("\n");
      sb.Append("  IsExactCodeSearch: ").Append(IsExactCodeSearch).Append("\n");
      sb.Append("  IsExactEmailSearch: ").Append(IsExactEmailSearch).Append("\n");
