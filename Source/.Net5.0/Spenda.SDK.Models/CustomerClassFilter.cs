...
namespace Spenda.SDK.Models {
  ...
  /// </summary>
  [DataContract]
  public class CustomerClassFilter {
    /// <summary>
    /// Gets or Sets IsGenericOnly
    /// </summary>
    [DataMember(Name="IsGenericOnly", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "IsGenericOnly")]
    public bool? IsGenericOnly { get; set; }

    /// <summary>
    /// Gets or Sets PostingBehaviours
    /// </summary>
    [DataMember(Name="PostingBehaviours", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "PostingBehaviours")]
    public List<string> PostingBehaviours { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class CustomerClassFilter {\n");
      sb.Append("  IsGenericOnly: ").Append(IsGenericOnly).Append("\n");
      sb.Append("  PostingBehaviours: ").Append(PostingBehaviours).Append("\n");
